	...
	<section class="news_section">
		...
		<article class="news_info_use">
		    <ul>
		        <li>개인정보처리방침</li>
		        <p> </p>
	                정보통신망법 규정에 따라 취업지원정책정보에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.

1. 수집하는 개인정보
이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 취업지원정책정보 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, 취업지원정책정보는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.

회원가입 시점에 취업지원정책정보가 이용자로부터 수집하는 개인정보는 아래와 같습니다.
...
취업지원정책정보에서 제공하는 위치기반 서비스에 대해서는 '취업지원정책정보 위치정보 이용약관'에서 자세하게 규정하고 있습니다.
