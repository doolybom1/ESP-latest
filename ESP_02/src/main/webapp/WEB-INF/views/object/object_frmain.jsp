...
<meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <link rel="stylesheet" href="${rootPath}/css/center/p_allSocialContent.css?ver=20191121033" type="text/css">
...
<%@ include file="/WEB-INF/views/include/include-p_allForeignerContent.jspf" %> <!-- 센터 -->
